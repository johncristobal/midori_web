...
const Home: NextPage = () => {
  return (
    <ShopLayout title={'Midori'} description={'Sitio para conocer Midori'}>
      <>
        {/* main view */}
        <div className="bg-gray-100">
            <section className="cover bg-blue-teal-gradient px-4 sm:px-8 lg:px-16 xl:px-40 2xl:px-64 overflow-hidden py-48 flex items-center min-h-screen">
                <div className="h-full absolute top-0 left-0 z-0">
                    <img src="images/friends.jpg" alt="" className="w-full h-full object-cover opacity-20" />
                </div>
        ...
        {/* section about */}
        <section className="relative px-4 py-16 sm:px-8 lg:px-16 xl:px-40 2xl:px-64 lg:py-32 font-nunito">
        ...
        {/* <!-- start testimonials --> */}
        <section className="relative bg-gray-100 px-4 sm:px-8 lg:px-16 xl:px-40 2xl:px-64 py-16 lg:py-32 font-nunito">
          <div className="flex flex-col lg:flex-row lg:-mx-8">
            <div className="w-full lg:w-1/2 lg:px-8">
        ...
        {/* <!-- start blog --> */}
        <section className="relative bg-white px-4 sm:px-8 lg:px-16 xl:px-40 2xl:px-64 py-32 font-nunito">
          <div className="">
